...
| Requirement | Status on 2026-09-08 | Evidence or required action |
| --- | --- | --- |
...
| Public open-source GitHub repository | Blocked on user remote | Add a GitHub remote and push the existing local history. |
...
| Demonstrable application | Ready locally | React workstation plus 72 passing Solidity tests. |
| Verified testnet addresses and rehearsal receipts | Pending funded signer | Follow [TESTNET.md](TESTNET.md); add evidence only after broadcast confirmation. |
